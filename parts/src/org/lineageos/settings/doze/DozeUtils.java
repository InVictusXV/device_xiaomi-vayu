...
public final class DozeUtils {
    ...
    public static final int PICK_UP_MODE_OFF = 0;
    public static final int PICK_UP_MODE_PULSE = 1;
    public static final int PICK_UP_MODE_WAKE = 2;
    ...
    public static int getPickUpMode(Context context) {
        try {
            return Integer.parseInt(PreferenceManager.getDefaultSharedPreferences(context)
                    .getString(GESTURE_PICK_UP_MODE_KEY, "0"));
    ...
    public static boolean sensorsEnabled(Context context) {
        return getPickUpMode(context) != PICK_UP_MODE_OFF ||
